(define (problem blocksworld-p00_4)
(:domain blocksworld)
(:objects
b0 b1 b2 b3 b4 - block
level11 level12 level13 level14 level15 level16 level17 level18 level19 level20 level21 level22 level23 level24 level25 level26 level27 level28 level29 level30 level31 level32 level33 level34 level35 level36 level37 level38 level39 - energylevel
h0 h1 - hand
)
(:init
