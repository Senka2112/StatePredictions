(define (problem blocksworld-p00_3)
(:domain blocksworld)
(:objects
b0 b1 b2 b3 - block
level11 level12 level13 level14 level15 level16 level17 level18 level19 level20 level21 level22 level23 level24 level25 level26 level27 level28 level29 - energylevel
h0 h1 - hand
)
(:init
